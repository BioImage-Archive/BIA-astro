...
**NEW:** You can now submit annotations, i.e. segmentation masks, meshes etc., with or without including the source images. [For annotations only submission instructions please click here.](/bioimage-archive/submit-annotations)
