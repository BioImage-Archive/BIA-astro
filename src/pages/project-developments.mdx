...
---
import rembi from "/src/assets/bioimage-archive/rembi.png" ;
import uk_ri_logo from "/src/assets/bioimage-archive/uk_ri_logo.jpg" ;
import EMBL_logo_colour_wordmark from "/src/assets/bioimage-archive/EMBL_logo_colour_wordmark.png" ;
import development_milestones from "/src/assets/bioimage-archive/development-milestones.png"
import governance from "/src/assets/bioimage-archive/bioimaging_governance_phase2.png"
...
<img alt="development milestones" src={development_milestones.src}/>
...
<img alt="bioimaging governance" src={governance.src}/>

### Community engagement

<img alt="community-engagement" src={rembi.src} class="float-right padding-left-large" />
...
<img class="padding-bottom-large" src={uk_ri_logo.src} style="height: 66px;" />
</a>
			
<a href="http://www.ebi.ac.uk" class="logo-img">
<img class="padding-bottom-large" src={EMBL_logo_colour_wordmark.src} style="height: 66px;" />
</a>
