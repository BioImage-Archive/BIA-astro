...
import flat_hierarchical from "/src/assets/bioimage-archive/flat_and_hierarchical.png";
import two_experiment_filelist from "/src/assets/bioimage-archive/two_experiment_filelist.png" ;
...
You must have one file list per <a href="/bioimage-archive/help/rembi-examples">study component</a> and one file list per annotations section (if applicable).
...
<figure class="center margin-bottom-large margin-right-large" style="width: 600px">
  <img src={flat_hierarchical.src} alt="different file structures"/>
</figure>
...
<figure class="center margin-bottom-large margin-right-large" style="width: 800px">
  <img src={two_experiment_filelist.src} alt="file lists per study component"/>
</figure>
