...
---
import ftp_aspera from "/src/assets/bioimage-archive/ftp-aspera.png" ;
import filelist_button from "/src/assets/bioimage-archive/filelist_button.png" ;
import BIA_annotation_template_view from "/src/assets/bioimage-archive/BIA_annotation_template_view.png" ;
import "/src/styles/figure_styling.css" ;
import {getTutorialURLs} from '../../components/SharedJSFunctions.js';

export const submission_url = await getTutorialURLs("submission");

Submitting Annotations to the BioImage Archive
---------------------------------------

These instructions are for annotations-only submissions, i.e. segmentation masks, point annotations, class labels etc., **without corresponding images.** The annotations are for already published image datasets in the BioImage Archive or another repository. For example you have created cell segmentations for an already public imaging dataset and you would like to submit the segmentations. For a full list of annotation types and brief descriptions [check here.](/bioimage-archive/ai-glossary)
...
<figure>
<img src={ftp_aspera.src} alt="" class="float-right float-top" style="height: 100px"/>
...
<figure>
<img src={filelist_button.src} alt="" class="float-center float-top" style="height: 120px"/>
<figcaption class="figure-caption"></figcaption>
</figure>
...
<figure>
<img src={BIA_annotation_template_view.src} alt="" class="float-center float-top" style="height: 500px"/>
<figcaption class="figure-caption"></figcaption>
</figure>
...
For detailed guidance on how to fill the submission form, how to add sections and edit your submission, please check the <a href={submission_url}>Submission subsection</a> of BIA online tutorial.
